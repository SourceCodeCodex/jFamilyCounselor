...
@ActionPerformer
public final class OpenInEditorFirst implements IActionPerformer<Void, MReferenceVariablesPair, HListEmpty> {

	public Void performAction(MReferenceVariablesPair mReferenceVariablesPair, HListEmpty hList) {
		try {
			JavaUI.openInEditor(mReferenceVariablesPair.getUnderlyingObject()._1().underlyingJdtObject(), true, true);
