package ro.lrg.jfamilycounselor.capability.generic.search.type.cast;
...
import ro.lrg.jfamilycounselor.capability.generic.search.requestor.EncolsingMethodRequestor;
...
/**
 * Capability that resolves all enclosing methods of a particular type's cast references.
 * 
...
public class TypeCastSearchCapability {
    ...
    private static final Cache<IType, List<IMethod>> cache = MonitoredUnboundedCache.getCache();
