package ro.lrg.jfamilycounselor.capability.common.parameter;
...
/**
 * Capability that attempts to determine the type of a particular parameter. It
 * makes use of the signature of the parameter and its project in order to
 * determine its type's IType object. As an alternative, one could use the
