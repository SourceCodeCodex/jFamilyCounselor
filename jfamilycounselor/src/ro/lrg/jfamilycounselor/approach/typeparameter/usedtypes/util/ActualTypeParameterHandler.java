...
public class ActualTypeParameterHandler {
	...
	if (!binding.isFromSource() || binding.isCapture() || binding.isPrimitive() || binding.isAnnotation() || binding.isAnonymous() || binding.isArray() || binding.isIntersectionType() || binding.isNullType())
	    return Optional.empty();

	if (binding.isGenericType() || binding.isParameterizedType() || binding.isRawType() || binding.isClass() || binding.isInterface() || binding.isEnum()) {
