 ...
 * same invoker. Combination need to be executed only once, for the initial
 * assignments pair.
 * 
...
public class ParameterParameterDerivation {
	...
	if (m1.equals(m2)) {
	    ...
	    return cartesianProduct(calls1Opt.get(), calls2Opt.get()).parallelStream()
			...
			if (haveSameInvoker(call1, call2)) {
    ...
    private static boolean haveSameInvoker(Expression invocation1, Expression invocation2) {
