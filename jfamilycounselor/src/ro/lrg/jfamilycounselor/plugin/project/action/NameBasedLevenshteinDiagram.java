...
@ActionPerformer
public final class NameBasedLevenshteinDiagram implements IActionPerformer<Void, MProject, HListEmpty> {

	@Override
	public Void performAction(MProject mProject, HListEmpty args) {
		var exportJob = new ExportDiagramRelationsJob(EstimationType.NAME_BASED_LEVENSHTEIN, mProject.getUnderlyingObject());
