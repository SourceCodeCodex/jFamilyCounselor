...
@ActionPerformer
public class AssignmentReport implements IActionPerformer<Void, MProject, HListEmpty> {

    @Override
    public Void performAction(MProject mProject, HListEmpty args) {
	var exportJob = new ExportReportJob(EstimationType.ASSIGNMENT_BASED, mProject.getUnderlyingObject());
