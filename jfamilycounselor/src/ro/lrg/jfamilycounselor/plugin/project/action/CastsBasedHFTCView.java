...
@ActionPerformer
public final class CastsBasedHFTCView implements IActionPerformer<Void, MProject, HListEmpty> {

	@Override
	public Void performAction(MProject mProject, HListEmpty args) {
		var exportJob = new ExportHFTCRelationsJob(EstimationType.CASTS_BASED, mProject.getUnderlyingObject());
