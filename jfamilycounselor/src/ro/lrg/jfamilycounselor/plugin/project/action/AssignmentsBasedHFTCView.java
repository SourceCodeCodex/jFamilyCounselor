...
@ActionPerformer
public final class AssignmentsBasedHFTCView implements IActionPerformer<Void, MProject, HListEmpty> {

	@Override
	public Void performAction(MProject mProject, HListEmpty args) {
		var exportJob = new ExportHFTCRelationsJob(EstimationType.ASSIGNMENTS_BASED, mProject.getUnderlyingObject());
