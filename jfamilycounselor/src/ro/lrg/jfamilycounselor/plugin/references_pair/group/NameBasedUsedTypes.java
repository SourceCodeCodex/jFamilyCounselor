...
public class NameBasedUsedTypes implements IRelationBuilder<MTypesPair, MReferencesPair> {
	...
	if (usedTypes.isEmpty())
	    throw new IllegalStateException("Name-nased used types computation for pair: " + mReferencesPair.toString() + " failed. Previous checks need to ensure that this situation cannot happen.");
