...
import ro.lrg.jfamilycounselor.capability.specific.aperture.PossibleTypesCapability;
...
public class PossibleTypes implements IRelationBuilder<MTypesPair, MReferencesPair> {
	...
	if (pair._1 instanceof IType && pair._2 instanceof ILocalVariable)
	    possibleTypes = PossibleTypesCapability.possibleTypesTP((Pair<IType, ILocalVariable>) pair);
