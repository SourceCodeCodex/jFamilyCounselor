package ro.lrg.jfamilycounselor.plugin.impl.model.`type`

import org.eclipse.core.runtime.NullProgressMonitor
import org.eclipse.jdt.core.{Flags, IType}
import ro.lrg.jfamilycounselor.plugin.impl.{MRefPair, MType, UsedConcreteTypePairsAlgorithm}
import ro.lrg.jfamilycounselor.plugin.impl.model.`type`.refs_combination.ParamCombinationStrategy
import ro.lrg.jfamilycounselor.plugin.impl.model.ref.SRefPair
...
final case class SType(jdtElement: IType) extends MType {
  ...
  lazy val concreteCone: List[SType] = {
    import ro.lrg.jfamilycounselor.plugin.impl.cache.implicits._
